...
<details>
<summary><b>🎯 Core Interests & Learning Focus (Click to expand)</b></summary>
<br>

- **⚙️ Backend Engineering:** Advanced API Design & Microservices
- **🚀 Distributed Systems:** Docker, Container Orchestration & DevOps
- **🔐 Network Security:** Decentralized Networks & Protocol Engineering
- **🤖 Machine Learning:** LLMs & AI Agents (Pydantic AI)

</details>

<details>
<summary><b>📈 Engineering Principles (Click to expand)</b></summary>
<br>
